...
Style: Default,Arial,28,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,1,0,0,0,100,100,0,0,1,2,0,2,10,10,300,1
Style: Highlight,Arial,28,&H0000FFFF,&H000000FF,&H00000000,&H00000000,1,0,0,0,100,100,0,0,1,2,0,2,10,10,300,1
...
def renderizar(req: RenderizarRequest):
    ...
    if legend_file:
        fc = (
            ...
            f"Outline=2,Alignment=2,MarginV=50'[subbed];"
            f"[subbed]{cta}[out]"
        )
    else:
        fc = (
